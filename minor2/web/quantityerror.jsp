...
<%
out.println("OOPS SORRY WE ARE UNABLE TO SUPPLY THIS QUANTITY :( ");
String n1=(String)session.getAttribute( "qtyofpro" );
out.print("<a href='buy.jsp?proname="+n1+"'>click to back...</a>");
%>
